document.addEventListener("alpine:init", () => {
  Alpine.data("products", () => ({
    items: [
      ...
      { id: 7, name: "Es Jeruk\t", img: "jeruk.jpg", price: 8000, detail : "Kaya akan vitamin C dan antioksidan, Es Jeruk kami membantu meningkatkan daya tahan tubuh dan memberikan sensasi asam segar yang menyegarkan." },
      { id: 8, name: "Es Kelapa Muda", img: "kelapa muda.jpg", price: 15000, detail : "Rasakan kesegaran alami dari air kelapa muda yang kaya mineral. Menyejukkan tubuh dan membantu melancarkan pencernaan." },
      ...
      { id: 11, name: "Es Teh\t", img: "teh.jpg", price: 6000, detail : " Dinginkan diri dengan segelas Es Teh yang manis alami dan segar. Cocok untuk menemani hari-harimu yang sibuk dan mengembalikan semangat." },
      ...
      { id: 14, name: "Bakmie Jawa", img: "bakmie.jpg", price: 15000, detail : "Bakmie Jawa: tradisional, gurih, kuah kental, mie kuning, irisan ayam, bawang goreng" },
      { id: 15, name: "Bakso\t", img: "bakso.jpg", price: 15000, detail : "Bakso kenyal dan kuah kaldu yang lezat, pilihan tepat untuk makan siang atau makan malam." },
      { id: 16, name: "Gudeg\t", img: "gudeg.jpg", price: 15000, detail : "Manis, gurih, santan lembut, nangka matang, rempah khas, tradisional Yogyakarta, mengenyangkan, lauk khas, cocok disantap pagi atau malam." },
      { id: 17, name: "Gurame Bakar", img: "gurame.jpg", price: 15000, detail : "Renyah kulit, daging lembut, bumbu meresap, aroma bakaran, segar, nikmat, khas Indonesia, sajian tradisional, irisan jeruk nipis, disajikan dengan sambal terasi." },
      { id: 18, name: "Nasi Bakar", img: "nasibakar.jpg", price: 15000, detail : "Harum, gurih, dibungkus daun pisang, tekstur krispi, aneka isian, tradisional, cita rasa pedas-manis, menggugah selera, cocok di acara piknik." },
      { id: 19, name: "Nasi Goreng", img: "nasigoreng.jpg", price: 15000, detail : "Selalu jadi favorit, dengan berbagai topping yang bisa kamu pilih sesuai selera." },
      { id: 20, name: "Rawon\t", img: "rawon.jpg", price: 15000, detail : "Kaya rempah dan daging sapi yang empuk, bikin kamu hangat dan berenergi." },
